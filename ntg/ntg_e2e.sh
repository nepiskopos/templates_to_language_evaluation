...
# Usage: ./ntg_e2e.sh -train [or -seg] [or -gen] -nar [or -war] [-decay] [-gpu]
...
if [[ $1 == -train ]]; then
    ...
    if [[ $2 == -nar ]]; then
        ...
        -mlpinp $decay $gpu -seed 1818 -save /root/neural-template-gen/models/e2e-55-5-new.pt."$dec"
    elif [[ $2 == -war ]]; then
        ...
        -mlpinp $decay $gpu -seed 1111 -save /root/neural-template-gen/models/e2e-60-1-war-new.pt."$dec" -ar_after_decay
    fi
elif [[ $1 == -seg ]]; then
    ...
    if [[ $2 == -nar ]]; then
        ...
        python2 /root/neural-template-gen/chsmm.py -data /root/neural-template-gen/data/e2e_aligned/ -emb_size 300 -hid_size 300 -layers 1 -K 55 -L 4 \
        -log_interval 200 -thresh 9 -emb_drop -bsz 10 -max_seqlen 55 -lr 0.5 -sep_attn -max_pool -unif_lenps -one_rnn -Kmul 5 \
        -mlpinp $decay $gpu -load /root/neural-template-gen/models/e2e-55-5-new.pt."$dec" -label_train \
        | tee /root/neural-template-gen/segs/seg-e2e-55-5-new-dec"$dec".txt
    elif [[ $2 == -war ]]; then
        # Run the segmentation for the autoregressive E2E model
        python2 /root/neural-template-gen/chsmm.py -data /root/neural-template-gen/data/e2e_aligned/ -emb_size 300 -hid_size 300 -layers 1 -K 60 -L 4 \
        -log_interval 200 -thresh 9 -emb_drop -bsz 10 -max_seqlen 55 -lr 0.5 -sep_attn -max_pool -unif_lenps -one_rnn -Kmul 1 \
        -mlpinp $decay $gpu -load /root/neural-template-gen/models/e2e-60-1-war-new.pt."$dec" -label_train -ar_after_decay \
    ...
    if [[ $2 == -nar ]]; then
        ...
        python2 /root/neural-template-gen/chsmm.py -data /root/neural-template-gen/data/e2e_aligned/ -emb_size 300 -hid_size 300 -layers 1 -K 55 -L 4 \
        -log_interval 200 -thresh 9 -emb_drop -bsz 10 -max_seqlen 55 -lr 0.5 -sep_attn -max_pool -unif_lenps -one_rnn -Kmul 5 -mlpinp $decay $gpu \
        ...
        python2 /root/neural-template-gen/chsmm.py -data /root/neural-template-gen/data/e2e_aligned/ -emb_size 300 -hid_size 300 -layers 1 -K 60 -L 4 \
        -log_interval 200 -thresh 9 -emb_drop -bsz 10 -max_seqlen 55 -lr 0.5 -sep_attn -max_pool -unif_lenps -one_rnn -Kmul 1 -mlpinp $decay $gpu \
