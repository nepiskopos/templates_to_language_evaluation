...
# Usage: ./ntg_e2e_original.sh -gen -nar [or -far] [-cuda]
...
if [[ $1 != -gen ]]; then
    echo 'Usage: ./ntg_e2e_original.sh -gen -nar [or -far] [-cuda]'
    
    exit 1
elif [[ $2 != -nar && $2 != -far ]]; then
    echo 'Usage: ./ntg_e2e_original.sh -gen -nar [or -far] [-cuda]'
...
if [[ $2 == -nar ]]; then
    ...
    -gen_from_fi /root/neural-template-gen/data/e2e_aligned/src_uniq_valid.txt -load /root/neural-template-gen/models/original_models/e2e-55-5.pt \-tagged_fi /root/neural-template-gen/segs/original_segs/seg-e2e-55-5.txt \
    -beamsz 5 -ntemplates 100 -gen_wts '1,1' $3 -min_gen_tokes 0 > /root/neural-template-gen/gens/original_gens/gen-e2e-55-5.txt
    ...
    -log_interval 100 -thresh 9 -lr 0.5 -sep_attn -unif_lenps -emb_drop -mlpinp -onmt_decay -one_rnn -max_pool \
    -gen_from_fi /root/neural-template-gen/data/e2e_aligned/src_uniq_valid.txt -load /root/neural-template-gen/models/original_models/e2e-60-1-far.pt -tagged_fi /root/neural-template-gen/segs/original_segs/seg-e2e-60-1-far.txt \
    -beamsz 5 -ntemplates 100 -gen_wts '1,1' $3 -min_gen_tokes 0 > /root/neural-template-gen/gens/original_gens/gen-e2e-60-1-far.txt
