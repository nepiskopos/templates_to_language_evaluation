...
if [[ $1 == -preprocess ]]; then
    ...
    python3 /root/tgen/e2e-challenge/postprocess/ /root/tgen/e2e-challenge/output/e2e-valid-outputs.txt \
    /root/tgen/e2e-challenge/output/e2e-valid-outputs-postprocessed.txt
    python3 /root/tgen/e2e-challenge/postprocess/ /root/tgen/e2e-challenge/output/e2e-test-outputs.txt \
